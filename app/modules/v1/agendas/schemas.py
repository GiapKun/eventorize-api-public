...
class Validate(BaseModel):
    ...
    def check_input_time(self) -> Self:
        if self.get("start_time") and self.get("end_time") and self.get("start_time") >= self.get("end_time"):
            raise AgendaErrorCode.EndTimeAfterStartTime()
        elif self.get("start_time") and self.get("end_time") and self.get("start_time") < self.get("end_time"):
            return self
        elif not self.get("start_time") and not self.get("end_time"):
            return self
        else:
